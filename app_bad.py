...
@app.route('/add_data', methods=['ADD'])
def add_data():
    id_spisok = request.form['add_id_spisok']
    if request.method == 'ADD':
        ...
        try:
            ...
            doc_type = request.form['id_doc_type']
...
@app.route('/save_data', methods=['POST', 'WRITE'])
def save_data():
...
@app.route('/delete_data/<int:record_id>', methods=['DELETE'])
